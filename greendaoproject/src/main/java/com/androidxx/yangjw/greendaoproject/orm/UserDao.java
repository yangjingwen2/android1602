...
public class UserDao extends AbstractDao<User, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property UserAge = new Property(2, Integer.class, "userAge", false, "USER_AGE");
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getInt(offset + 2), // userAge
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setUserAge(cursor.isNull(offset + 2) ? null : cursor.getInt(offset + 2));
