...
import com.handmark.pulltorefresh.library.internal.BoxLayout;
	...
	protected LoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs) {
		LoadingLayout layout = null;
				if (mode == Mode.PULL_FROM_START ) {
					...
					layout = new FlipLoadingLayout(context, mode,
							getPullToRefreshScrollDirection(), attrs);
				}
...
//		mFooterLayout = createLoadingLayout(context, Mode.PULL_FROM_END, a);
		mFooterLayout = new FlipLoadingLayout(context, Mode.PULL_FROM_END,
...
//					return new RotateLoadingLayout(context, mode, scrollDirection, attrs);
					return new BoxLayout(context, mode, scrollDirection, attrs);
				case FLIP:
