...
import com.androidxx.yangjw.shoppingcartdemo.MainActivity;
...
public class PayTool {
    ...
    public static String  pay(Activity context, String name, String desc, float price) {
